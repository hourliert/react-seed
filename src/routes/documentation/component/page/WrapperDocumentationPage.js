...
import ExamplePersonalInfo from 'components/ExamplePersonalInfo';
import ExamplePersonalEmail from 'components/ExamplePersonalEmail';
import TabDialog from 'components/TabDialog';

// Examples
import { EXAMPLE1, EXAMPLE3, EXAMPLE4, EXAMPLE5 } from './examples';
...
export default class WrapperDocumentationPage extends Component {
  ...
  getTableWrapperExample() {
    ...
    return (
        ...
        <Paper>
          ...
          <div style={styles.exampleContainer}>
            <TableWrapper
              data={data}
              tableMeta={tableMeta}
              onCellClick={(datum) => { console.log(datum); }} //eslint-disable-line
            />
          </div>
        </Paper><br /><br />
      <h3>TableWrapper Properties</h3>
          ...
          <Table>
            ...
            >
              <TableRow>
                ...
                <TableHeaderColumn style={styles.tableHeaderDesc}>
                  Description
                </TableHeaderColumn>
              </TableRow>
            </TableHeader>
            ...
            >
              ...
              <TableRow>
                ...
                <TableRowColumn />
                <TableRowColumn style={styles.tableHeaderDesc}>If the selectable
                  option in the tableMeta is on,<br />
        ...
        <p>
          The tableMeta object contains a precise description of the Table to
          get the content and the look you want.
        ...
        <h4>tableProperties (Object)</h4>
            ...
            >
              ...
              <TableRow>
                ...
                <TableRowColumn style={styles.tableHeaderDesc}>
                  ...
                  <br />If multiple row selection is desired, enable multiSelectable.
                </TableRowColumn>
              </TableRow>
              <TableRow>
                ...
                <TableRowColumn style={styles.tableHeaderDesc}>
                  ...
                  <br />CTRL/CMD+Click and SHIFT+Click are valid actions.
                </TableRowColumn>
              </TableRow>
              <TableRow>
                ...
                <TableRowColumn style={styles.tableHeaderDesc}>
                  ...
                  <br />If set to false, the button will not be interactable.
                </TableRowColumn>
              </TableRow>
            </TableBody>
          </Table>
            ...
            <Table>
              ...
              >
                <TableRow>
                  ...
                  <TableRowColumn >true</TableRowColumn>
                  <TableRowColumn style={styles.tableHeaderDesc}>
                    Controls whether or not to deselect all selected rows after
                ...
                <TableRow>
                  ...
                  <TableRowColumn >false</TableRowColumn>
                  <TableRowColumn style={styles.tableHeaderDesc}>
                    If true, every other table row starting with the first row
                    will be striped
                  </TableRowColumn>
                </TableRow>
                <TableRow>
                  ...
                  <TableRowColumn >false</TableRowColumn>
                  <TableRowColumn style={styles.tableHeaderDesc}>
                    If true, table rows will be highlighted when the cursor
          ...
          <h4>mutlipleProperties (Object)</h4>
            ...
            <p>In this object, you can describe each columns. The description
              object has this shape :</p>
              <Table>
                <TableHeader
                  selectable={false}
                  displaySelectAll={false}
                ...
                >
                  ...
                  <TableRow>
                    ...
                    <TableRowColumn />
                    <TableRowColumn style={styles.tableHeaderDesc}>
                      if searchable is set to 'AUTOCOMPLETE', set the behavior of
                      the completion :<br />
                    'static' (selectfield MUI component), or 'suggest'
                    (AutoComplete MUI component).<br />
                    Example : <br /><br />
                    <div style={styles.code}>
                      <pre>
                        {EXAMPLE4}
                ...
                - maxSearchResults is the number of proposition you want to display.
                  ...
                  <TableRow>
                    ...
                    <TableRowColumn />
                    <TableRowColumn style={styles.tableHeaderDesc}>
                      You can wrapp a cell with a custom conponent. The cell content
                      will be passed to<br /> it throught 'value' props.
  ...
  getTabDialogExample() {
    const { user, updateUser, fetchCurrentUser } = this.props;
    return (
      <Paper zDepth={1} style={{ padding: 25 }}>
        <h2>TabDialog</h2>
        <hr />
        <p>Creating multi-tab dialog window can be very challenging using basic
          MUI components.<br /><br />
          If each tabs have complex components that are able to edit the application's
          state, we really want these components to be informed about what's the user
          do with the modal's action buttons. With the TabDialog component, callbacks
          and modal lifecycle's functions are injected to each tab children.This will
          help you to perform rountine depending of what the user decided to do (cancel,
          create ... etc).<br /><br />
          You can also provide a refresh function to TabDialog that will be executed
          when all tab children callback are received. In this function, you can for
          example refresh an object from the API if some the ressource has been edited
          by a tab components.
        </p>
        <h3>Example</h3>
        <div style={styles.exampleHeader}>
        ...
        <div style={styles.exampleContainer}>
          <div style={{ width: '100%', textAlign: 'center' }}>
            <div style={{ color: '#4caf50' }}>{this.state.greetingStatus}</div>
            Welcome ! You are <b>{user.firstName} {user.lastName}</b> and
            your email address is <b>{user.email}</b><br /><br />
            <FlatButton
              label="Edit my info"
        ...
        <ul>
          <li>
              In this example, <b>TabDialog</b> contains 2 children :<b>ExamplePersonalInfo </b>
              and <b>ExamplePersonalEmail</b>.
              Their props are user object and updateUser function that allow them to
              update the user throught the backend API. <b>TabDialog</b> component
              injects functions userDidAction() and userDidCancel() which are
              automatically called by <b>TabDialog</b> when user clicks on cancel or
              save button. It also provides a callback function to inform the <b>TabDialog </b>
              that the child component has finished its job, so <b>TabDialog</b> can call global
              refresh function.
          </li><br />
          <li>
              If the user clicks on save, child component can update the user via
              updateUser(). When it's done, it calls callback(true), that means we want
              the main page to refresh the user ressource via an action so we can update
              the greeting message.
          </li><br />
          <li>
              If the user clicks on cancel, child component do nothing and calls directly
              callback(false). That means we don't need a refresh.
          </li><br />
          <li>
              <b>TabDialog </b> gathers all the callback from its children and decides
              whether or not to call refresh function.
          </li>
        </ul>
        </div>
      </Paper>
  ...
  getStepContent(stepIndex) {
    switch (stepIndex) {
      case 0:
        return (this.getTableWrapperExample());
      case 1:
        return (this.getTabDialogExample());
      case 2:
        return (this.getFormExample());
      default:
